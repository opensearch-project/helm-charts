...
| `autoscaling`                          | Configurable pod autoscaling stratergy to scale based on targetCPUUtilizationPercentage, configure minReplicas and maxReplicas for desired scaling                                                                                                                                                        | false                             |