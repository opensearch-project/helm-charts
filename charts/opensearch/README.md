...
| `sysctl`              | Allows you to enable the `sysctl` to set sysctl vm.max_map_count through `securityContext`. This requires privilege.                                                                                                                                         | `enabled: false`                                 |
| `sysctlInitContainer`              | Allows you to enable the `sysctlInitContainer` to set sysctl vm.max_map_count through privileged `initContainer`.                                                                                                                                        | `enabled: false`                                 |
